...
public class MainWindow extends JFrame {
	...
	*/
	...
	private VizualizationPanel m_vizualizationPanel;
	...
	private void initGui() {
		...
		m_vizualizationPanel = new VizualizationPanel();
		
		m_contentPane.add(createMainSplitPane(m_topologyPanel, m_graphPanel, m_vizualizationPanel), BorderLayout.CENTER);
	}
	...
	private JSplitPane createMainSplitPane(JPanel topologyPanel, JPanel graphPanel, JPanel vizualizationPanel) {
		JSplitPane mainSplitPane = new JSplitPane();
		JSplitPane vizuSplitPane = new JSplitPane();
		...
		vizuSplitPane.setResizeWeight(0.1);
		vizuSplitPane.setLeftComponent(mainSplitPane);
		vizuSplitPane.setRightComponent(vizualizationPanel);
		
		// return mainSplitPane;
		return vizuSplitPane;
	}
	...
	public VizualizationPanel getVizualizationPanel() {
		return m_vizualizationPanel;
	}
