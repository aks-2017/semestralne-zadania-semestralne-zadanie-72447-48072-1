...
public class OfTopology {
	...
	private Map<String, OfDevice> m_deviceMap;
	
	public OfTopology() {
	}
	
	public OfTopology(Map<String, OfSwitch> switchMap, Map<String, OfLink> linkMap, Map<String, OfDevice> deviceMap) {
		this.m_switchMap = switchMap;
		this.m_linkMap = linkMap;
		this.m_deviceMap = deviceMap;
	}
	...
	public void setDeviceMap(Map<String, OfDevice> deviceMap) {
		this.m_deviceMap = deviceMap;
	}
	...
	public Map<String, OfDevice> getDeviceMap() {
	...
	public OfDevice getDevice(String ipv4) {
		// TODO: 
		return null;
	}
